            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 py-10 sm:py-12">
                <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-[#e2e8e4] p-6 sm:p-8 md:p-10 transform transition-all">
                    <div className="text-center mb-8 sm:mb-10">
                        <h1 className="text-3xl font-serif text-[#3e564c] mb-2">Join Velora</h1>
                        <p className="text-[#8c9490]">Create your account and start shopping</p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="••••••••" 
                            />
                            <p className="mt-1.5 text-[10px] text-[#8c9490] ml-1">Must be at least 8 characters</p>
                        </div>
                        ...
                        <div className="flex items-start ml-1">
                            ...
                            <label htmlFor="terms" className="ml-2 block text-xs text-[#8c9490] leading-relaxed">
                                I agree to the <a href="#" className="text-[#68a49c] hover:underline">Terms of Service</a> and <a href="#" className="text-[#68a49c] hover:underline">Privacy Policy</a>
                            </label>
                        </div>
